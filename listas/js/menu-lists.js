...
<header class="scroll">    
  ...
  <a href="../listas/0-listas-cel.htm" class="m-active">Clasificación</a>
...
<li><a href="../padecimientos.htm">Búsqueda sintomática</a></li>
				...
				<li id="opcion1" class="m-active"><a href="#opcion1" onclick="toggle_visibility('menu1');" onmouseover="big_menu();" onmouseout="short_menu();" style="color:#777">Clasificación</a>		
