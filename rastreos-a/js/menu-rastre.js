document.write(`
		<!-- Cel-Bar --> 
		<div class="barra-menu2">
			<div class="cel-bar"> 
			<!-- logo celular -->
			<div class="logo-fondo tablet-show"><img src="../graficos/logo1b.png" width="160px" alt=""/></div>
			<div class="logo-fondo cel-show"><img src="../graficos/logo1b.png" width="160px" alt=""/></div>
		</div>
...
<div class="btn-mastemas"><a href="#" onclick="toggle_visibility('mastemas');" class="mastemas">Enlaces / lector</a></div>
			</div></div>
...
<li><a href="../listas/especiales.htm" target="_self">Especiales</a></li>			 
				...
				<li id="opcion7"><a href="#opcion7"><img src="../iconos/menu-protocolos1.png" width="35px" alt=""/></a>
					<ul id="menu7">		
						...
						<li><a href="../rastreos/r_zonas.htm" >Completo: x zonas</a></li>
			...
			<div class="pc-cabeza">
				<div class="header" id="header">
					...
					style="width:819; max-width:80%; float:left; margin-left: 15px; z-index:555" height="90%" alt=""/></div>
					<div class="adorno" id="adorno" alt=""></div>
					<!-- Menu-Bar -->
					<div class="barra-menu" width="100%" id="barra-menu">
						<ul  class="acorh">	
							<li><a href="../index.html">Home</a></li>
							<li><a href="../padecimientos.htm">Búsqueda sintomática</a></li>
...
<li><a href="../listas/especiales.htm" target="_self">Especiales</a></li>			
									<li><a href="../listas/disfuncionales.htm" target="_self">Disfuncionales</a></li>
									<li><a href="../listas/reservorios.htm" target="_self">Reservorios</a></li><li><a href="../listas/mas-pares.htm" target="_self">Más listas...</a></li>	
								</ul>		
							</li>
							<li id="opcion2" onmouseover="big_menu();" onmouseout="short_menu();" class="m-active"><a href="#opcion2"  onclick="toggle_visibility('menu2');" style="color:#777">Niveles Rastreo</a>		
...
<li><a href="../tutorial/par.htm" >Introducción al P.B.</a></li>
